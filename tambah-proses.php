...
if (isset($_POST['tambah'])) {
	...
	$input = mysqli_query($koneksi, "INSERT INTO tbl_siswa (siswa_nis, siswa_nama, siswa_kelas, siswa_jurusan) VALUES('$siswa_nis', '$siswa_nama', '$siswa_kelas','$siswa_jurusan')") or die(mysqli_error($koneksi));

	// jika query input sukses
	if ($input) {
	    // Pesan jika proses tambah sukses
		echo 'Data berhasil di tambahkan! ';
    		//membuat Link untuk kembali ke halaman tambah
